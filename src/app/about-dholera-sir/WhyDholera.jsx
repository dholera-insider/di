...
import { ChartNoAxesCombined , Building2 , Route, Landmark, MapPinned, Network } from "lucide-react";
...
const benefits = [
  ...
  {
    title: "Part of the Delhi Mumbai Industrial Corridor (DMIC)",
    icon: Route,
  },
  {
    title: "Government Backed Smart City Development",
    icon: Landmark,
  },
  {
    title: "Dedicated Industrial & Residential Zones",
    icon: MapPinned,
  },
  {
    title: "World Class Infrastructure & Connectivity",
    icon: Network,
  },
  {
