      ...
      <div className="md:hidden mt-6">
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/30 w-full">
          <div className="grid gap-6 p-6">
            ...
            <div>
              <Link href="/residential-projects-in-dholera/westwyn-estate">
                <p className="text-2xl font-bold text-[#051A3A] hover:text-[#2B364D] mb-2 leading-tight">
                  <span className="text-base font-bold text-[#051A3A]">
            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="text-[#051A3A] text-center text-xl font-semibold hover:text-[#2B364D] transition-colors">
